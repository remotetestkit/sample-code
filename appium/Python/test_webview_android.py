...
class WebviewAppTest(unittest.TestCase):
    ...
    def test_webview(self):
        ...
        # URL入力
        nEdittext = self.driver.find_element(By.ID, "et_weburl")
        nEdittext.clear()
        nEdittext.send_keys("https://nr--test.web.app/webviewapp/")
        self.driver.save_screenshot("capture_02.png")

        # ログインボタン押下
        nLoginButton = self.driver.find_element(By.ID, "loginButton")
        nLoginButton.click()
        sleep(5)
        ...
        # Webviewを閉じる
        nCloseButton = self.driver.find_element(By.ID, "closeButton")
        nCloseButton.click()
        sleep(3)
